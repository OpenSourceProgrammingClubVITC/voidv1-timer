...
const STUDENT_COORDINATORS_INFO = [
  {
    name: "Dhanvanthini B",
    photoUrl: "/ospc.png",
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto my-16">
          {STUDENT_COORDINATORS_INFO.map((info) => (
            <div
              key={info.name}
              className="rounded-2xl p-6 md:p-8 liquid-container"
            >
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="size-24 rounded-xl overflow-hidden relative flex-shrink-0">
                  <Image
                    src={info.photoUrl}
                    alt={`${info.name} logo`}
                    fill
                ...
                <div className="text-white/90 w-full">
                  ...
                  <p className="text-white/75 text-lg font-medium mb-3">
                    {info.phoneNumber}
                  </p>
